...
void Player::update_player_gravity() {
    ...
    if (LevelManager::getInstanceLevel().is_colliding({Player::getInstancePlayer().get_player_pos_X(), Player::getInstancePlayer().get_player_pos_Y() - 0.1f}, WALL) && player_y_velocity < 0) {
    ...
    player_on_ground = LevelManager::getInstanceLevel().is_colliding({Player::getInstancePlayer().get_player_pos_X(), Player::getInstancePlayer().get_player_pos_Y() + 0.1f}, WALL);
